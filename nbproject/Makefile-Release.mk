...
${OBJECTDIR}/Chromosome.o: Chromosome.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chromosome.o Chromosome.c
...
${OBJECTDIR}/ExponentialRankingSelection.o: ExponentialRankingSelection.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExponentialRankingSelection.o ExponentialRankingSelection.c
...
${OBJECTDIR}/InsertMutation.o: InsertMutation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InsertMutation.o InsertMutation.c

${OBJECTDIR}/InversionMutation.o: InversionMutation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InversionMutation.o InversionMutation.c

${OBJECTDIR}/InvertedDisplacementMutation.o: InvertedDisplacementMutation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InvertedDisplacementMutation.o InvertedDisplacementMutation.c

${OBJECTDIR}/MemoryGenetic.o: MemoryGenetic.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MemoryGenetic.o MemoryGenetic.c
...
${OBJECTDIR}/RandomMutation.o: RandomMutation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomMutation.o RandomMutation.c

${OBJECTDIR}/SwapMutation.o: SwapMutation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SwapMutation.o SwapMutation.c

${OBJECTDIR}/TournamentSelection.o: TournamentSelection.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TournamentSelection.o TournamentSelection.c
